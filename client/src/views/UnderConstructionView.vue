    ...
    <div class="w-full max-w-md overflow-hidden mx-3">
      <div class="px-4 py-2 mt-2">
        ...
        <div class="flex items-center justify-center">
          <i class="fa-solid fa-wrench text-green-500 text-7xl"></i>
        </div>
        <h2 class="text-2xl font-semibold text-center text-appText-light dark:text-appText-dark mt-8">Under Construction</h2>
        <p class="text-sm text-center text-gray-500 mt-2">
          Sorry but this page is still under construction. Please check back later.
        </p>
      </div>
    </div>
  </section>

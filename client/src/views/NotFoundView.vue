  ...
  <section class="flex items-center justify-center h-screen bg-appPrimary-light dark:bg-appPrimary-dark">
    <div class="w-full max-w-md overflow-hidden mx-3">
      <div class="px-4 py-2 mt-2">
        ...
        <h2 class="text-2xl font-semibold text-center text-appText-light dark:text-appText-dark mt-8">Not Found</h2>
        <p class="text-sm text-center text-gray-500 mt-2">
          Sorry but the page you are looking for does not exist. Please check the URL and try again.
        </p>
      </div>
    </div>
  </section>
